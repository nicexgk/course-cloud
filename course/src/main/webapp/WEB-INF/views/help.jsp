...
<body>
		...
		<div class="content-c">
			...
			<div class="right">
				<div class="select" id="s1">
					...
					<p class="title">1.在开始学习之前，花点时间了解几个基本的概念，可以帮助您更快熟悉Nice课堂。</p>
					<p class="cont">
						在Nice课堂中，您可以报名任意的课程，每个课程中含有若干的章和节，每个章或节之下会有若干个学习任务，学习任务的类型包括：直播任务、录播任务、习题任务等，您可以通过各种类型的任务进行学习。当您完成所有的学习任务后，就完成了该门课程的学习。各种课程、章节、学习任务由授课老师安排，如果在课程内容上有任何建议，您可以联系老师沟通。
					</p>
					<p class="title">2.在Nice课堂可以做什么？</p>
					<p class="cont">
				...
				<div class="select" id="s2">
					...
					<p class="title">1.请确认您已下载最新版本的个人信息，点击下方按钮下载最新版个人信息：</p>
					<p class="cont">
						在Nice课堂中，您可以报名任意的课程，每个课程中含有若干的章和节，每个章或节之下会有若干个学习任务，学习任务的类型包括：直播任务、录播任务、习题任务等，您可以通过各种类型的任务进行学习。当您完成所有的学习任务后，就完成了该门课程的学习。各种课程、章节、学习任务由授课老师安排，如果在课程内容上有任何建议，您可以联系老师沟通。
					</p>
					<p class="title">2.在网页报名了课程，如何学习？</p>
					<p class="cont">
						报名课程后，即可在个人信息面板上看到与自己相关的课程信息。双击课程即可进入课程的任务列表，或者直播课堂（当有报名课程有直播任务正在直播时）。
					</p>
				...
				<div class="select" id="s7">
					...
					<p class="title">2.分期支付的规则</p>
					<p class="cont">
						报名课程后，即可个人信息面板上看到与自己相关的课程信息。双击课程即可进入课程的任务列表，或者直播课堂（当有报名课程有直播任务正在直播时）。
					</p>
					<p class="title">3.为何选择某些支付渠道后交易金额比课程金额少？</p>
					<p class="cont">
						因为某些支付渠道会在课程单价的基础上给予一定的折扣。
	...
	<div class="footer">
		<div class="footer-content">
			...
			<p>深圳市Nice计算机系统有限公司 版权所有 | Nice课堂服务协议 | 站点地图</p>
		</div>
	</div>
</body>
<script>
